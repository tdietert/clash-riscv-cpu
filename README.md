...
- [Project overview](#project-overview)
  - [clash-riscv-cpu.cabal](#namecabal)
...
# Change the license
By default `clash-riscv-cpu.cabal` sets its `license` field to `BSD-2-Clause`. You might want to change this.
